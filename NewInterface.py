...
layout = [
    [sg.Text(" "*72, background_color=Color), sg.Text('Opponent :',
                                                      justification="right", background_color=Color, text_color="black", font=13)],
    [sg.Text(" ", background_color=Color),
     sg.Image(filename="Images/rock.png",
              key="EnemyRock", background_color=Color),
     sg.Image(filename="Images/paper.png",
              key="EnemyPaper", background_color=Color),
     sg.Image(filename="Images/scissors.png", key="EnemyScissors", background_color=Color)],
    [sg.Text(" "*62, background_color=Color), sg.Text('          Score : 0/0',
                                                      key='-DYNAMIC_TEXT-', font=16, background_color=Color, text_color="black")],
    [sg.Text(" "*72, background_color=Color), sg.Text("Your choice : ",
                                                      background_color=Color, text_color="black", font=13)],
    [sg.Button(image_filename="Images/rock.png", button_color=('white'), key="Rock", border_width=5),
     sg.Button(image_filename="Images/paper.png",
               button_color=('white'), key="Paper", border_width=5),
...
window = sg.Window('Pierre Feuille Ciseaux', layout,
                   finalize=True, background_color=Color)
...
def ColorText(Result):
    ...
    """
    if Result == "Lost !":
        window["-DYNAMIC_TEXT-"].update(
            f"{Result}   Points : {UserPoint}/{RobotPoint}", text_color='red')
    elif Result == "Won !":
        window["-DYNAMIC_TEXT-"].update(
            f"{Result}   Points : {UserPoint}/{RobotPoint}", text_color='green')
    else:
        window["-DYNAMIC_TEXT-"].update(
            f"{Result}   Points : {UserPoint}/{RobotPoint}", text_color='black')
